        ...
        <>
            ...
            <ContentGraficsBar>
                <ContentBar2>
                    ...
                    <ContentBar3>
                        <CheckMonths monthNumber={3} text={'Marzo'} selectedMonth={selectedMonth} setSelectedMonth={setSelectedMonth}/>
                        <CheckMonths monthNumber={4} text={'Abril'} selectedMonth={selectedMonth} setSelectedMonth={setSelectedMonth}/>
                        <CheckMonths monthNumber={5} text={'Mayo'} selectedMonth={selectedMonth} setSelectedMonth={setSelectedMonth}/>
                        <CheckMonths monthNumber={6} text={'Junio'} selectedMonth={selectedMonth} setSelectedMonth={setSelectedMonth}/>
                        <CheckMonths monthNumber={7} text={'Julio'} selectedMonth={selectedMonth} setSelectedMonth={setSelectedMonth}/>
                        <CheckMonths monthNumber={8} text={'Agosto'} selectedMonth={selectedMonth} setSelectedMonth={setSelectedMonth}/>
                        <CheckMonths monthNumber={9} text={'Septiembre'} selectedMonth={selectedMonth} setSelectedMonth={setSelectedMonth}/>
                        <CheckMonths monthNumber={10} text={'Octubre'} selectedMonth={selectedMonth} setSelectedMonth={setSelectedMonth}/>
                        <CheckMonths monthNumber={11} text={'Noviembre'} selectedMonth={selectedMonth} setSelectedMonth={setSelectedMonth}/>
                        <CheckMonths monthNumber={12} text={'Diciembre'} selectedMonth={selectedMonth} setSelectedMonth={setSelectedMonth}/>
                    </ContentBar3>
            </ContentGraficsBar>
        </>
    )
